...
<H1> 회원정보를 생성 완료했습니다. 확인해 볼까요?</H1>
<h3>아이디:<jsp:getProgerty name="dto" property="id"/></h3>
<h3>암호:<jsp:getProgerty name="dto" property="pw"/></h3>
<h3>이름:<jsp:getProgerty name="dto" property="name"/></h3>
<h3>폰:<jsp:getProgerty name="dto" property="phone"/></h3>
<h3>이메일:<jsp:getProgerty name="dto" property="email"/></h3>
</body>
</html>